...
#     print('Puedes conducir'.capitalize())
...
# el candidato debe ser capaz de programar en Python 
...
# Utiliza la base de código ya proporcionada para plantear la estructura de control 
# de flujo apropiada y verificar dichas condiciones. 
