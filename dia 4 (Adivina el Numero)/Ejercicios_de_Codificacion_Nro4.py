# Crea un Loop While que se imprima en 
# pantalla los números del 10 al 0, uno a la vez.
# print('numeros del 10 al 0'.upper().center(50, '*'))
...
# Crea un Loop While que reste de uno en 
# uno los números desde el 50 al 0 (ambos 
# números incluídos) con las siguientes condiciones adicionales:
...
# - Si el número no es divisible por 5, 
# continuar ejecutando el loop sin mostrar el valor en pantalla 
# (no te olvides de seguir restando para que el programa no corra infinitamente).

# print('numeros divisibles en 5'.upper().center(50, '*'))
