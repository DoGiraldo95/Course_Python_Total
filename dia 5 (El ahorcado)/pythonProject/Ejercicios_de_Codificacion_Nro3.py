...
# resulte de resolver una potencia, utilizando el primer número como base, y el segundo como exponente
...
# Práctica Return 2
# Crea una función llamada usd_a_eur que tome como único parámetro un valor numérico (un monto en
...
#
# Crea una variable llamada dolares y almacena en ella un monto cualquiera para entregárselo a tu función y evaluar
# su resultado.
#
...
dolares = 2
euro = usd_a_eur(dolares)

print(f'Valor en euro es := {euro} euros')


# Práctica Return 3
#
# Crea una función llamada invertir_palabra que tome los caracteres de una palabra dada como
...
def invetir_palabra(words):
    invertir = words[::-1].upper()
    return invertir


palabra = 'python'

print(invetir_palabra(palabra))
